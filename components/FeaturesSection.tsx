      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-400 mt-5 max-w-2xl mx-auto">
            Designed for professionals, startups and legal consultants across India.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-white/5 border border-white/10 backdrop-blur-xl
                           p-8 rounded-3xl hover:border-purple-500/40
                           transition-all duration-300 hover:scale-[1.03]"
              >
                <div className="mb-6">
                  <Icon className="h-10 w-10 text-purple-500 group-hover:text-purple-400 transition" />
                </div>
                ...
                {/* Glow */}
                <div className="absolute inset-0 rounded-3xl bg-purple-600/5 opacity-0 group-hover:opacity-100 transition blur-xl" />
              </div>
            );
          })}
        </div>
